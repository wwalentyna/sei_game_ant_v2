...
const sourceThemes = [
  ...
  {
    title: 'Research gap: alternative aerosol materials',
    detail: 'Used for Level 4: particle material. Sulfate is the known baseline; CaCO₃/calcite is partly known; future engineered particles are uncertain and need laboratory, measurement and model evidence.',
  },
];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 md:p-8 font-sans">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <InfoCard>
          <h2 className="mb-4 flex items-center gap-2 text-2xl font-black text-white"><BookOpen className="text-emerald-400" /> Source themes used in the game</h2>
          ...
          <p className="mt-4 text-xs text-slate-500">
            Note for the presentation: replace these source-theme labels with the exact paper titles from your final reference list if your professor requires formal citations on the website.
          </p>
        </InfoCard>
          ...
          <div className="space-y-6 lg:col-span-7">
            ...
            <InfoCard>
              ...
              <div className="mt-4 rounded-2xl border border-purple-500/30 bg-purple-950/20 p-4 text-sm text-purple-100">
                Current knowledge: {indicators.knowledge}%. Future particles unlock at 70% knowledge after 2080. In the presentation, this box is where you explain the research gap: we cannot claim that a new particle is safer until cooling efficiency, atmospheric lifetime, particle growth/coagulation, optical scattering and side effects are tested.
              </div>
            </InfoCard>
