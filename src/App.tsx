...
const sourceThemes = [
  {
    ...
    detail: 'Affects Level 2 directly and Level 1 indirectly. The paper compares annual, spring and autumn SAI strategies and shows that similar global cooling targets can lead to different regional rainfall and sea-ice outcomes. In the game this sets the annual / spring / autumn trade-off and the ice-rain side effects.',
  },
  {
    title: 'Cohen et al. (2025): The impact of stratospheric aerosol injection: a regional case study',
    detail: 'Affects the food-security and rainfall outcomes. The paper compares climate change with SAI scenarios for Global South regions and links SAI to heat extremes, wet-season precipitation, soil moisture and crop productivity. In the game this is why cooling can help food, but rain and soil-moisture loss can still cause collapse.',
  },
  {
    title: 'Duffey et al. (2023): Solar Geoengineering in the Polar Regions: A Review',
    detail: 'Affects Level 3 and Arctic-risk outcomes. The review explains why polar regions are difficult to cool with low-latitude SAI, why targeted polar strategies may protect ice more directly, and why asymmetric cooling can create rainfall-shift and governance risks.',
  },
  {
    title: 'Lecture background only: aerosol characterization and transport methods',
    detail: 'Supports Level 4 methods, not the climate-outcome rules. It is used only to explain what must be tested for a future particle: generation, particle size distribution, optical scattering, coagulation/agglomeration, settling/lifetime and transport modelling.',
  },
];
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <InfoCard>
          ...
          <p className="mt-4 text-xs text-slate-500">
            Main simulation outcomes are based on the three research papers. The lecture material is background only: it supports the Level 4 research-gap methodology, not the climate scores.
          </p>
        </InfoCard>
